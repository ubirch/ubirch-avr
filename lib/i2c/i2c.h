...
#define I2C_STATUS_ARB_LOST_OR_NACK     TW_MT_ARB_LOST
#define I2C_STATUS_SLAR_ACK             TW_MR_SLA_ACK
#define I2C_STATUS_SLAR_NACK            TW_MR_SLA_NACK
#define I2C_STATUS_RCVD_DATA_ACK        TW_MR_DATA_ACK
#define I2C_STATUS_RCVD_DATA_NACK       TW_MR_DATA_NACK
